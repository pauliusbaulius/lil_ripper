...
welcome = """
> lil ripper is active, it will now rip pages specified in riplist...
"""
print(welcome)
...
def execute_riplist():
    """
    Tries it's best to download everything from riplist and put it in respective directories.
    :return:
    """
    pass
